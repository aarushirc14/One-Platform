...
export const divisionCommunities: DivisionCommunityRow[] = [
  {
    ...
    target: '13',
    gapTone: 'negative',
    webTraffic: { label: '+0.5 sales', band: 'u1', conversionLabel: '3850 (1.8%)' },
    totalLeads: { label: '-0.3 sales', band: 'n', conversionLabel: '283 (-1.4%)' },
    firstVisits: { label: '+0.4 sales', band: 'n', conversionLabel: '115 (0.6%)' },
    salesImpact: { label: '-6.3 sales', band: 'd4', conversionLabel: '6 (-34.2%)' },
  },
  {
    id: 'gladden-farms',
    name: 'Gladden Farms',
    ...
    target: '12',
    gapTone: 'negative',
    webTraffic: { label: '-10.4 sales', band: 'd5', conversionLabel: '875 (-19.8%)' },
    totalLeads: { label: '-7.8 sales', band: 'd5', conversionLabel: '46 (-17.2%)' },
    firstVisits: { label: '-3.1 sales', band: 'd4', conversionLabel: '29 (-19.0%)' },
    salesImpact: { label: '-5.0 sales', band: 'd4', conversionLabel: '4 (-40.5%)' },
  },
  {
    id: 'saddlebrook',
    name: 'Saddlebrook',
    ...
    target: '8',
    gapTone: 'neutral',
    webTraffic: { label: '+1.0 sales', band: 'u2', conversionLabel: '1610 (3.6%)' },
    totalLeads: { label: '+0.7 sales', band: 'u1', conversionLabel: '218 (3.4%)' },
    firstVisits: { label: '+1.3 sales', band: 'u2', conversionLabel: '81 (8.8%)' },
    salesImpact: { label: '-0.5 sales', band: 'd2', conversionLabel: '8 (-2.1%)' },
  },
  {
    id: 'tanque-verde',
    name: 'Tanque Verde',
    ...
    target: '6',
    gapTone: 'negative',
    webTraffic: { label: '+1.5 sales', band: 'u2', conversionLabel: '1780 (5.5%)' },
    totalLeads: { label: '-2.0 sales', band: 'd3', conversionLabel: '102 (-7.8%)' },
    firstVisits: { label: '-1.1 sales', band: 'd2', conversionLabel: '36 (-11.5%)' },
    salesImpact: { label: '-3.9 sales', band: 'd4', conversionLabel: '2 (-48.5%)' },
  },
]
